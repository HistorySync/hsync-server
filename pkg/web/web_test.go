...
func TestLandingPageIncludesTimelineLookupPanel(t *testing.T) {
	...
	checks := []string{
		...
		`id="support-timeline-quota-card"`,
		`id="support-timeline-device-card"`,
		`id="support-timeline-event-card"`,
		`id="support-timeline-repair"`,
		`id="support-timeline-repair-status"`,
		`id="recalculate-support-quota" type="button" disabled`,
		`id="refresh-support-context-after-action" type="button" disabled`,
		`id="support-timeline-repair-summary"`,
		`id="support-timeline-repair-result"`,
