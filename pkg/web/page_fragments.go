...
func pageStyles() string {
	return strings.Join([]string{
		...
		".result-box{margin:10px 0 0;max-height:360px;overflow:auto;background:var(--code);color:#e4e7ec;border-radius:6px;padding:10px;font-size:.84rem;white-space:pre-wrap}",
