...
func TestEveryCodeInCatalog(t *testing.T) {
	...
	codes := []Code{
		...
		CodeConflict, CodeAccountDeletionBlocked, CodeAccountDeletionReview,
		CodeEmailTaken, CodeInvalidCredentials,
		CodeInvalidRefreshToken, CodeInvalidResetToken, CodeInvalidVerificationToken,
		CodePasskeyDisabled, CodePasskeyInvalid, CodePasskeyNotFound,
		CodeSignupsDisabled, CodeStepUpExpired, CodeStepUpInvalid, CodeStepUpRequired,
		CodeTwoFactorAlreadyEnabled, CodeTwoFactorChallengeInvalid, CodeTwoFactorInvalidCode,
		CodeTwoFactorLocked, CodeTwoFactorNotEnabled, CodeTwoFactorRequired,
